...
$descriptions = @{
    ...
    "github-sub-issues"              = "Use when creating sub-issues or sub-tasks, or breaking a feature into per-repository work items - the tracking-issue pattern (a parent tracking issue with a Sub-issues table plus one self-contained sub-issue per repository, each referencing the parent; canonical example DiGi.GIS.PostgreSQL #83)."
